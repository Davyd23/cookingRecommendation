<head>
				...
				<style type="text/css">
					...
					/* Footerblurb */
					#footerblurb { background:#b43838;color:red;}
					#footerblurb-inner { margin:0 auto; width:922px; padding:24px;}
					#footerblurb .column { margin:0; text-align:justify; float:left;width:250px;padding:0 24px;}
					
					/* Footer */
					#footer { background:#b43838; }
					#footer-inner { margin-top: 750px; text-align:center; padding:18px; width:922px; color: #ccc;}
			...
			<footer id="footer">
				<div id="footer-inner">
					<p>&copy; Copyright <a href="#">cookingRec</a> &#124; <a href="#">Terms of Use</a> &#124; <a href="#">Privacy Policy</a></p>
					<div class="clr"></div>
				</div>
			</footer>
